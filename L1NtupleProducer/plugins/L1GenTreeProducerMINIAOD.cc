...
class L1GenTreeProducerMINIAOD : public edm::EDAnalyzer {
public:
  explicit L1GenTreeProducerMINIAOD(const edm::ParameterSet&);
  ~L1GenTreeProducerMINIAOD() override;
...
L1GenTreeProducerMINIAOD::L1GenTreeProducerMINIAOD(const edm::ParameterSet& iConfig)
{
...
L1GenTreeProducerMINIAOD::~L1GenTreeProducerMINIAOD()
{
...
void
L1GenTreeProducerMINIAOD::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  if (genParticles.isValid()) {
    ...
    for(size_t i = 0; i < genParticles->size(); ++ i) {
      ...
      for(unsigned int i=0;i<nMo;++i){
        ...
        if (((abs(thisParentID) >= 23) && (abs(thisParentID) <= 25)) ||
             (abs(thisParentID) == 6) ||
             (hundredsIndex == 5) ||
             (hundredsIndex == 4) ||
             (thousandsIndex == 5) ||
      ...
      if ((parentID != p.pdgId()) && 
      ((parentID > -9999) || (abs(id) == 11) || (abs(id) == 13) || (abs(id) == 23) || (abs(id) == 24) || (abs(id) == 25) || (abs(id) == 4) || (abs(id) == 5) || (abs(id) == 6))){
...
void 
L1GenTreeProducerMINIAOD::beginJob(void)
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
L1GenTreeProducerMINIAOD::endJob() {
}

//define this as a plug-in
DEFINE_FWK_MODULE(L1GenTreeProducerMINIAOD);
